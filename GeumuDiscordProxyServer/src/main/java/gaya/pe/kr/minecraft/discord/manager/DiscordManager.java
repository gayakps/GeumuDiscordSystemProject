package gaya.pe.kr.minecraft.discord.manager;

import gaya.pe.kr.core.thread.VelocityThreadUtil;
...
public class DiscordManager {
    ...
    public void init() {
        ...
        try {
            ...
            TextChannel channel = jda.getTextChannelById("channel_id_here");
